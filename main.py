...
if __name__ == "__main__":
    ...
    FLAGS.local_rank = os.getenv(int("SLURM_PROCID"), FLAGS.local_rank)
    FLAGS.gpus       = os.getenv(int("GPUS_PER_NODE"), FLAGS.gpus)
    FLAGS.nodes      = os.getenv(int("SLURM_JOB_NUM_NODES"), FLAGS.nodes)
